        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3 pb-3 border-b">
            <div className="space-y-0.5">
              ...
              <div className="text-sm font-medium" style={{ color: getColorFromValue(calculatePM10Aqi, pm10) }}>
                {pm10.toFixed(1)}
              </div>
            </div>
            <div className="space-y-0.5">
              <div className="text-xs text-muted-foreground">VOC</div>
              <div className="text-sm font-medium" style={{ color: getColorFromValue(calculateVOCAqi, voc) }}>
                {Math.round(voc)}
              </div>
            </div>
            <div className="space-y-0.5">
              <div className="text-xs text-muted-foreground">Humidity</div>
              <div className="text-sm font-medium" style={{ color: getHumidityColor(humidity) }}>
                {humidity.toFixed(1)}%
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 pb-3 border-b">
            <div className="space-y-0.5">
              ...
              <div className="text-sm font-medium" style={{ color: getColorFromValue(calculateHCHOAqi, hcho) }}>
                {hcho.toFixed(1)}
              </div>
            </div>
            <div className="space-y-0.5">
              <div className="text-xs text-muted-foreground">NOx</div>
              <div className="text-sm font-medium" style={{ color: getColorFromValue(calculateNOxAqi, nox) }}>
                {nox.toFixed(1)}
              </div>
            </div>
            <div className="space-y-0.5">
              <div className="text-xs text-muted-foreground">PM0.3</div>
              <div className="text-sm font-medium" style={{ color: getPM03Color(pm03) }}>
                {pm03.toFixed(1)}
              </div>
            </div>
          </div>
